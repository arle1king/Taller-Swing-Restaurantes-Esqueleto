...
public class VentanaAgregarRestaurante extends JFrame
{
    ...
    public VentanaAgregarRestaurante( VentanaPrincipal principal )
    {
        ...
        surPanel.add(panelDetalles, BorderLayout.CENTER);
        surPanel.add(panelBotones, BorderLayout.SOUTH);
    ...
    {
        // TODO completar
        String name = panelDetalles.getNombre();
        ...
        ventanaPrincipal.agregarRestaurante(name, calificacion, coordenadas[0], coordenadas[1], visitado);
        cerrarVentana();
    }
